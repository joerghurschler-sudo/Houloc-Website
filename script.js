...
const artistData = {
    "Hugo Ferretto": {
       text: "<div style='margin-bottom: 12px;'>En avançant dans ma recherche certaines questions reviennent constamment. La construction de la peinture place le regardeur. La construction perspective de la <strong>Renaissance</strong> le fait advenir comme unique sujet. Qu’en est-il s’il n’y a plus de représentation ? Si la peinture est abstraite ? Où se place le sujet de la peinture abstraite autant dans l’espace réel que sur la toile ?</div><div style='margin-bottom: 12px;'>Devant chaque tableau s’opère un jeu à trois variantes : ce qui est peint, sa position dans l’espace, la place que cela donne au regardeur. Pour faciliter la sensation de projection, j’ai d’abord peint des débuts d’espaces (sols, murs, plans), devenus ensuite des pans colorés et des formes géométriques, jusqu’au lieu coloré absolu : le <strong>monochrome</strong>.</div><div style='margin-bottom: 12px;'>La condition de regard m’intéresse plus que le sujet. Je fais dialoguer un monochrome, agissant comme point focal, et un schéma numérique qui paraphrase la situation de la peinture à une autre échelle. Qu’y a-t-il entre ces deux propositions ? Quel type d’espace ? Je peins des monochromes en pensant autant à <strong>De Chirico</strong> et à <strong>Bacon</strong> qu’à <strong>Malevitch</strong>.</div><div style='margin-bottom: 12px;'>L’importance réside dans la communication entre l’objet tableau et l’image. C’est pourquoi j’ai quitté le châssis pour peindre sur <strong>bois</strong>, permettant des arêtes plus nettes. Je laisse les tranches nues pour favoriser le jaillissement de la surface. Dernièrement, je m’attache à l’idée de <i>reflet</i> ou de <i>lumière</i>, venant troubler la nature du tableau, entre surface et profondeur.</div>",
    ...
    "Marta Budkiewicz": {
        text: "<div style='margin-bottom: 12px;'>Diplômée des <strong>Beaux-Arts de Paris</strong>, dans l'atelier de <strong>Giuseppe Penone</strong>, mon travail de plasticienne s'ancre souvent dans des souvenirs personnels. J'y explore les traces infimes, les bruits à la lisière du silence, afin d'interroger le rapport au temps et à la mémoire.</div><div style='margin-bottom: 12px;'>Issue d'une formation musicale approfondie en piano, j'intègre dans ma pratique des médiums variés tels que le dessin, la vidéo, le son et l'installation. J'y tisse des liens entre ces différentes approches et les façons d'appréhender ce qui est observé.</div><div style='margin-bottom: 12px;'>Mon travail cherche également à suspendre et à revenir vers ce qui a été, ce qui ne peut être saisi que par fragments dispersés : les perceptions sensibles, les souvenirs, ces instants fragiles et fugaces qui laissent des empreintes, faisant dialoguer réalité, mémoire et expérience vécue.</div>",
    ...
    "Pauline Toyer": {
        text: "<div style='margin-bottom: 12px;'><strong>Pauline Toyer</strong>, née en 1987, vit et travaille à Blois (Cormeray) et Paris. Elle est diplômée de l'<strong>ENSA Bourges</strong> (2010) et a été résidente du post-diplôme de l'<strong>ENSBA Lyon</strong> (2014).</div><div style='margin-bottom: 12px;'>Elle a participé à plusieurs expositions personnelles et collectives, notamment aux <strong>Vestibule(s) de la Maison rouge</strong>, Fondation Antoine de Galbert, Paris (2014), à la +359 Gallery, Sofia (2019), au <strong>Creux de l'Enfer</strong>, Thiers (2020) et au <strong>Centre de création contemporaine Olivier Debré</strong> à Tours (2023).</div><div style='margin-bottom: 12px;'>Elle a été lauréate du programme de résidence de l'<strong>ADAGP</strong> à la <strong>Cité internationale des arts</strong> (2022).</div><div style='margin-bottom: 12px;'>Investie dans des projets collaboratifs, elle organise notamment avec <strong>Celsian Langlois</strong> l'évènement <i>Réunion Confort</i> à Cormeray (41). Ce projet est mené par l'association <strong>ateliers Canard</strong> qu'iels ont co-fondée en 2019 afin de soutenir la création artistique en milieu rural.</div>",
    ...
    "Jules Dumoulin": {
   text: "<div style='margin-bottom: 12px;'>Diplômé de la <strong>Villa Arson</strong> en 2018, ma pratique se déploie dans le champ de la sculpture et de l'installation, particulièrement dans l'usage des techniques de <strong>moulage</strong>.</div><div style='margin-bottom: 12px;'>À la suite d'un grave accident de la route en 2015, j'ai ressenti le besoin, pour me ré-éduquer et pour me vider la tête, de marcher. J'ai arpenté de long en large la ville de Nice et toutes celles que je visitais. Lors de ces dérivées, mon attention s'arrêtait exclusivement sur des parties de véhicules cassés, des bribes déformées d'objets mécaniques. Ces objets me trouvaient, en quelque sorte. Ces fragments, je les ai accumulés, et, dans l'idée de les « rendre œuvre », je les ai soclés : je leur ai construit pour eux des supports de métal.</div><div style='margin-bottom: 12px;'>La <strong>Villa Arson</strong> terminée, j'ai rapporté à Paris uniquement la partie « objet trouvé » qui composait mes sculptures. J'ai commencé à les mouler puis à les reproduire en <strong>cire</strong> que je teignait de pigments et de pastels fondus.</div><div style='margin-bottom: 12px;'>La <strong>cire</strong> m'a laissée, d'une part, une forme de « droit à l'erreur » — je pouvais refondre ce qui ne me convenait pas, travailler ma technique de <strong>moulage</strong>, et l'affiner vers un geste plus simple centré sur la couleur, dans une démarche picturale. La <strong>sérialisation</strong> s'est établie comme un élément central de ma pratique. Je produis un minimum de formes nouvelles, je re-moule ainsi plutôt mes sculptures et j'en scanne certaines pour les imprimer en <strong>3D</strong> et jouer avec leur échelle, leurs matériaux.</div><div style='margin-bottom: 12px;'>Ainsi, mon travail s'est progressivement constitué autour des notions de <strong>sobriété</strong> et de <strong>réemploi</strong> empruntées à la pensée écologique, visant à tendre vers une remise en circulation perpétuelle des objets que je crée. Je trouve intéressant par ce protocole de fragiliser la valeur d'unicité de l'œuvre d'art ainsi que celle du geste artistique à l'heure où la notion de <strong>productivité</strong> est sérieusement remise en question.</div>",
   instagram: "https://www.instagram.com/julesdumoulin/",
    ...
    "Noemie Vincent Maudry": {
        text: "<div style='margin-bottom: 12px;'><strong>Noémie Vincent Maudry</strong>, artiste designeuse, née en 2001 en Bourgogne, est diplômée des <strong>Beaux-Arts du Mans</strong> en Design et Territoire en 2024 autour d'un travail sur des relations sensibles entre les êtres humains et leur environnement, notamment à travers l'attention portée aux plantes adventices, souvent réduites au statut de «mauvaises herbes».</div><div style='margin-bottom: 12px;'>Ces végétaux, présents dans les interstices des villes et les marges des paysages, deviennent des figures de résistance et des indicateurs d'écosystèmes discrets. Les notions d'espaces rudéraux, de friches et de tiers paysage que décrit dans son travail <strong>Gilles Clément</strong> permettent de penser ces lieux délaissés comme des réservoirs de biodiversité.</div><div style='margin-bottom: 12px;'>Ces réflexions prennent espace dans son travail à travers des sculptures, objets, photographies et installations, ainsi que des procédés expérimentaux comme l'anthotype.</div><div style='margin-bottom: 12px;'>Elle interroge notre regard sur le vivant et cherche à cultiver une attention renouvelée au monde qui nous entoure, en développant un dialogue poétique entre humains, matières et territoires.</div><div style='margin-bottom: 12px;'>Elle a exposé au <strong>Musée d'Art Moderne de Paris</strong> (<i>Les Flammes</i>, 2021), au <strong>Centre Céramique Contemporaine de La Borne</strong> (<i>Digital Soba</i>), à la <strong>Biennale Internationale de Design de Saint Étienne</strong> (<i>Le monde Sinon rien</i>, 2022), et récemment à Paris, au <strong>Wonder</strong> (<i>Summer Body</i>) et au <strong>Micro Centre d'Art de L'éprouvette</strong> (<i>Terra Strata</i>).</div>",
    ...
    "Anaïs Benguigui": {
        text: "<div style='margin-bottom: 12px;'><strong>Anaïs Benguigui</strong> est une artiste peintre basée à Paris. Diplômée des <strong>Beaux-Arts de Paris</strong> et formée en philosophie à la <strong>Sorbonne</strong>, elle développe une pratique picturale qui explore l'identité comme un processus de transformation continue, façonné par les relations, la mémoire et les héritages.</div><div style='margin-bottom: 12px;'>À partir de photographies issues de son environnement proche, elle réalise des peintures figuratives de grand format qui interrogent les moments de transition psychique et relationnelle.</div>",
    ...
    "Joerg Hurschler": {
      text: "<div style='margin-bottom: 12px;'><strong>Joerg Hurschler</strong> est un artiste visuel travaillant dans les nouveaux médias, mêlant cinéma, animation et esthétique du jeu vidéo pour explorer comment les systèmes de pouvoir façonnent l'espace, la perception, l'identité et la vie quotidienne.</div><div style='margin-bottom: 12px;'>Il est titulaire d'un Master of Arts en cinéma de la <strong>Haute École d'art et de design de Lucerne</strong> (Suis se) et de l'<strong>Université Hongik</strong> à Séoul, en Corée du Sud.</div>",
       website: "https://www.joerghurschler.com",
        instagram: "https://www.instagram.com/joergoninsta",
        images: [
            { src: "img/Joerg-Hurschler-1.jpg", caption: "" },
            { src: "img/Joerg-Hurschler_Schwarm.avif", caption: "Schwarm, 2023" },
{ src: "img/Joerg-Hurschler_State-Zero.avif", caption: "The aesthetics of state zero - Body 0.1, 2025" },
            { src: "img/Joerg-Hurschler-Deadworld-Protocol-still.avif", caption: "Deadworld Protocol, 2025" }, 
            { src: "img/Joerg-Hurschler-5.jpg", caption: "Entités numérique - Variante x0.01z, 2022" }
        ]
    },

    "Audrey Matt Aubert": {
        text: "<div style='margin-bottom: 12px;'>Ma pratique de la peinture s'attache à la présentation d'objets et de paysages magiques composés d'élements hétéroclytes (sphères, fruits, papillons, objets sculpturaux etc.) empruntés à divers corpus, depuis la peinture italienne du XVème siècle jusqu'aux sculptures modernes en passant par les illustrations d'encyclopédies du XVIIIème siècle.</div><div style='margin-bottom: 12px;'>Ce processus de citation s'élabore à partir de reproductions d'oeuvres glanées sur internet ou collectées sous forme de cartes postales mais aussi plus rarement à partir d'un travail d'observation d'objets existants. Les hybridations de sources iconographiques hétéroclites me permettent de créer des espaces magiques et d'engager une réflexion sur le rêve et les possibilités de la surface picturale.</div><div style='margin-bottom: 12px;'>Le plus souvent plongées sur fond de ciel nocturne ou d'une mer de sable, ces petites compositions deviennent les nouveaux protagonistes de mes peintures. En peignant les choses en portrait, je les investis d'une fonction narrative, dans chaque peinture les objets, textures, animaux ou végétaux sont présentés comme des personnages de théâtre. Ils sont des embrayeurs d'histoires qu'il reste à réveiller.</div>",
         website: "https://audreymattaubert.com/homepage/",
        instagram: "https://www.instagram.com/audrey.matt.aubert/",
        images: [
            { src: "img/Audrey-Matt-Aubert_1.avif", caption: "Galerie Isabelle Gounod, 2022" },
            { src: "img/Audrey-Matt-Aubert_2.avif", caption: "" },
            { src: "img/Audrey-Matt-Aubert_5.avif", caption: "Le grand paon, 2022, huile sur papier toilé, 56x47,6cm" },
       
            { src: "img/Audrey-Matt-Aubert_3.avif", caption: "Bleu Sahara III, 2022, huile sur papier toilé, 18,8x14cm" },
                 { src: "img/Audrey-Matt-Aubert_4.avif", caption: "Désirs du désert, 2022, huile sur toile, 170x136cm" },
            { src: "img/Audrey-Matt-Aubert_6.avif", caption: "Passiflore, 2022, huile sur toile, 120x86cm" }
        ]
    },

    "Mélissa Boucher": {
        text: "<div style='margin-bottom: 12px;'><strong>Mélissa Boucher</strong> est une artiste Franco-Bolivienne diplômée des <strong>Beaux-Arts de Paris</strong> qui développe ses projets en photographie, vidéo et dans des éditions d'artiste.</div><div style='margin-bottom: 12px;'>Le fil conducteur qui relie ses différents projets est un questionnement en miroir portant sur la part du réel et le statut de l'image.</div><div style='margin-bottom: 12px;'>À travers ses photographies, elle cherche à capturer les potentialités narratives de scènes, d'espaces, ou d'arrangements intérieurs. Elle s'intéresse en particulier aux à côté, à la présence d'objets ou de formes en apparence secondaires ouvrant un espace de jeu entre le récit documentaire et la fiction.</div>",
    ...
    "Agathe Dos Santos": {
      text: "<div style='margin-bottom: 12px;'>Diplômée des <strong>Beaux-Arts de Paris</strong> en 2019, j'axe ma recherche plastique autour de la survivance des images. Dernièrement j'ai réalisé une série de gravures sur bois décorées au feutre posca, où chaque tirage est l'occasion de repenser l'oeuvre, de changer la narration et les couleurs.</div><div style='margin-bottom: 12px;'>Les scènes que je représente sont issues de collages, où j'associe des figures de la peinture préraphaélite à celles de mannequins du défilé <i>Horn of Plenty</i> d'<strong>Alexander Mcqueen</strong>. Ces visages fardés aux couleurs pop et saturées, sont ceux de personnages ambigus et fluides.</div><div style='margin-bottom: 12px;'>La production de ces « femmes en série » me permet d'imaginer une multitude de personnages au travers desquels je projette certains de mes fantasmes. Reines, magiciennes, chimères, celles-ci deviennent des figures protectrices, comme des icônes ou des ex-votos.</div>",
    ...
    "Lise Stoufflet": {
        text: "<div style='margin-bottom: 12px;'>La peinture de <strong>Lise Stoufflet</strong> prend pour sujets des situations à cheval entre le réel et le fantastique. Cet entre-deux, qui est, précisément, l'apanage du conte, justifie une figuration narrative d'autant plus dérangeante et décalée que le traitement est simple et ancré dans un réel spatio-temporel par le biais d'une forme d'illustration.</div><div style='margin-bottom: 12px;'>Les traits sont nets, presque aseptisés, et les corps des personnages sont lisses comme ceux de pantins. Si bien que chaque élément est placé sous un signe générique – une femme, un homme, une main, un château, une maison, un lac – dans une douce schématisation qui laisse la scène ouverte à un possible réagencement.</div><div style='margin-bottom: 12px;'>Aucun détail superflu ne vient brouiller la lisibilité de l'œuvre et l'absence de caractérisation engendre une standardisation des figures, comme des emblèmes ou des poupées. Dans cette affirmation des formes, s'alimente l'étrangeté des compositions.</div><div style='margin-bottom: 12px; font-style: italic;'>C'est au sein même de la narration, offerte à la vue, que le bât blesse.</div><div style='margin-top: 12px; font-style: italic;'>— Elora Weill-Engerer</div>",
    ...
    "Mehdi Besnainou": {
        text: "<div style='margin-bottom: 12px;'><strong>Mehdi Besnainou Dounkas</strong> est un artiste français vivant à Paris. Il fait ses études à <strong>Olivier de Serres</strong> et aux <strong>Beaux-Arts de Paris</strong>.</div><div style='margin-bottom: 12px;'>Le travail de <strong>Mehdi Besnainou</strong> est pluridisciplinaire et questionne avec humour et sarcasme les rites, codes et tendances actuelles de sa génération et de ses contemporains.</div><div style='margin-bottom: 12px;'>Que ce soit dans ses pensées les plus introspectives ou dérisoires sur la condition humaine, ses troubles psychologiques, ses identités et dilemmes face à sa place dans une société en perpétuelle changement, son travail se caractérise par un jeu permanent entre langage oral, écrit et dessiné, répertoire journalier compulsif d'analogie sur les mouvements du monde, à la manière d'un polymathe à l'ère du numérique.</div><div style='margin-bottom: 12px;'>Partant du dessin et de l'écriture, sa pratique artistique s'étend à la peinture, la vidéo, la performance et la musique.</div><div style='margin-bottom: 12px;'>Le travail de <strong>Mehdi Besnainou</strong> a fait l'objet d'expositions de peinture, de performance, de concerts, de projection vidéo ou de carte blanche mêlant différents mediums dans des centres d'arts internationaux tels que le <strong>Palais de Tokyo</strong>, le <strong>Palais de Chaillot</strong> ou encore la <strong>Villette</strong>. Récemment son travail a été visible au <strong>19M</strong>, à la <strong>galerie Fille du Calvaire</strong> ou au <strong>musée de la chasse et de la nature</strong>.</div>",
    ...
    "Laure Tiberghien": {
        text: "<div style='margin-bottom: 12px;'>Il n'est pas rare, à propos des photographies sans appareil de <strong>Laure Tiberghien</strong>, de faire référence aux peintures de <strong>Mark Rothko</strong> ou de <strong>Barnett Newman</strong>. Les œuvres de l'artiste, le plus souvent composées d'aplats colorés et de bandes ou lignes vibratoires, trouvent de fait des échos formels convaincants auprès de ces deux figures majeures de l'histoire de l'art américain.</div><div style='margin-bottom: 12px;'>Pour autant, il semble que son œuvre aurait à gagner à se défaire au moins temporairement de cette possible généalogie. D'abord parce que la question de l'abstraction n'est sans doute pas de celles qui comptent vraiment pour <strong>Laure Tiberghien</strong>. Sans pour autant vouloir renouer avec un quelconque désir de représentation, elle signale que les enjeux sont ailleurs.</div><div style='margin-bottom: 12px;'>L'artiste insiste sur les gestes qui président à ses images. Si elle évoque volontiers la dimension physique, voire chorégraphique du travail en laboratoire – « ce qui donne cet aspect vaporeux à l'image », explique-t-elle, « c'est le fait que je sois toujours en train de bouger » – elle souligne aussi l'incidence forte du type de support sur le rendu (sa brillance ou sa matité, son chatoiement), et la part de hasard inhérente au processus qu'elle aime guetter et amplifier.</div><div style='margin-bottom: 12px;'>Le papier photographique n'est pas seulement pour <strong>Laure Tiberghien</strong> le lieu où la lumière agit, mais aussi celui où se matérialise le contact de l'image avec le monde : l'air qui l'oxyde est aussi celui que nous respirons, et nous partageons cet invisible commun.</div><div style='margin-bottom: 12px;'>C'est aussi une logique ready-made qui guide <strong>Laure Tiberghien</strong> lorsqu'elle récupère d'anciens papiers citrates qu'elle laisse progressivement brunir à la lumière. Ces petits rectangles de feuille sensible, en apparence modestes, sont parmi ses pièces les plus directes et les plus explicites.</div><div style='margin-bottom: 12px;'>Ils tracent une autre voie que celle des références d'artistes peintres ou photographes, qui est celle du travail de la lumière, de sa traduction dans la matière photochimique soumise à l'écoulement du temps – notion considérée comme décisive par l'artiste. Les images de <strong>Laure Tiberghien</strong>, de ce point de vue, sont des matrices temporelles. Elles génèrent des zones colorées plus ou moins intenses résultant d'une certaine durée, des sortes de « couleurs-temps ».</div><div style='margin-bottom: 12px;'>Fruit du hasard mais aussi des collectes de l'artiste, matière changeante soumise à variations, résultat conjoint d'un support, d'un geste et d'une action lumineuse, ce que donne à voir l'œuvre n'est autre que la consistance même du temps.</div><div style='margin-top: 12px; font-style: italic;'>— Nathalie Delbard</div>",
        website: "https://www.lauretiberghien.com/",
        instagram: "https://www.instagram.com/lauretiberghien/",
        images: [
            { src: "img/Laure-Tiberghien_3.avif", caption: "Gradation #11" },
            { src: "img/Laure-Tiberghien_1.avif", caption: "499 #2" },
            { src: "img/Laure-Tiberghien_2.avif", caption: "Citrate" },
            { src: "img/Laure-Tiberghien_5.avif", caption: "MOONS" },
            { src: "img/Laure-Tiberghien_4.avif", caption: "Lithique #10" }
        ]
    },

    "Laura Rouzet": {
        text: "<div style='margin-bottom: 12px;'>Sous forme d'anticipation spéculative, <strong>Laura Rouzet</strong> tisse des univers aux frontières poreuses où les environnements humain, végétal, animal, minéral ou artificiel se confondent et se prolongent.</div><div style='margin-bottom: 12px;'>Explorant les vestiges du vivant et ses potentialités d'évolution, son travail plonge dans les zones troubles de la nature et de ses psychés. À l'intersection de la sculpture, de l'installation, et de la danse, sa pratique est marquée par l'expérience du corps, qu'elle perçoit comme un tissu connectif qui nous lie à l'autre.</div><div style='margin-bottom: 12px;'>De la prise d'empreinte au mouvement, le corps et la matière – argile, sève naturelle, grès – s'émancipent dans des espaces liminaires pour devenir autre.</div><div style='margin-bottom: 12px;'>En cette ère d'anxiété environnementale, <strong>Laura Rouzet</strong> interroge la perméabilité des statuts humains et non-humains en imaginant de nouvelles formes d'équilibre dans un futur alternatif, possible ou rêvé.</div>",
    ...
    "Mathieu Roquigny": {
        text: "<div style='margin-bottom: 12px;'><strong>Mathieu Roquigny</strong> entreprend une démarche où hasard, quotidien et humour entrent en interaction. Le jeu, le détournement d'objets mais surtout l'instinct de collectionneur sont des constantes de son travail qui se construit à travers l'ordinaire.</div><div style='margin-bottom: 12px;'>L'usage d'un vocabulaire formel minimal et de matériaux modestes confère à ses œuvres une apparente simplicité qui ne fait que renforcer leur redoutable efficacité. Mathieu pénètre en effet un champ performatif où tout ce qui l'entoure peut être soumis à une seconde lecture, à une tout autre interprétation, intensément plus profonde et essentielle.</div><div style='margin-bottom: 12px;'>Cette impression de créer tout en passant le temps, en s'arrêtant sur des fragments de l'éphémère et du banal, tout en révélant leur pouvoir vital, dégage une insatiable sensation de fragilité et, étrangement, d'attirante et de joyeuse beauté.</div><div style='margin-bottom: 12px; font-style: italic;'>C'est cette polysémie qui donne toute sa richesse et son originalité à l'œuvre de Mathieu Roquigny.</div><div style='margin-top: 12px; font-style: italic;'>— Pauline Guelaud</div>",
    ...
    "Lenny Rébéré": {
        text: "<div style='margin-bottom: 12px;'>« C'est un rituel auquel <strong>Lenny Rébéré</strong> s'astreint quotidiennement en rentrant de son atelier : il cherche, sélectionne et archive les images qui lui arrivent au gré de ses requêtes, parmi les quelques deux cent millions de clichés publiés chaque jour sur Internet. Ces images décontextualisées, désirées par l'artiste pour les formes qui les composent, viennent ponctuer ses œuvres, s'emmêlant les unes aux autres pour former des paysages brumeux.</div><div style='margin-bottom: 12px;'>Comme lorsqu'on avance au bord d'un chemin sur lequel une lourde fumée s'est s'évanouie, c'est donc en tâtonnant que l'on découvre le travail de <strong>Lenny Rébéré</strong>. Même son évolution chromatique qui semblerait a priori réchauffer ses peintures (l'artiste passant du noir et blanc, au rouge) les maintient plongées dans une atmosphère toujours plus énigmatique, propre aux déambulations nocturnes.</div><div style='margin-bottom: 12px;'>C'est la couleur que les lampadaires de nos villes étalent chaque nuit sur nos chaussées, elle est la chaude lumière qui voile les balades baudelairiennes. Un rouge qui agit aussi en contraste entre une photographie que l'on viendrait révéler, embaumée de l'éclairage sanguin des chambres noires, et une image sans doute jamais couchée sur papier, aujourd'hui égarée dans les abîmes du numérique. »</div><div style='margin-top: 12px; font-style: italic;'>— Extrait du texte <i>Au-delà du visible</i> par Camille Bardin pour l'exposition <i>Infras</i>, 2019, Galerie Isabelle Gounod, Paris.</div>",
    ...
    "Charlotte Heninger": {
      text: "<div style='margin-bottom: 12px;'><strong>Charlotte Heninger</strong> met en scène de nouvelles potentialités d’interaction entre les espèces passées, présentes et futures dans des paysages fictifs comme des cartes postales d’un monde qui n’existe pas encore. Son travail propose une vision sur nos intériorités, les espèces, les genres : un animisme futuriste.</div><div style='margin-bottom: 12px;'>Les dispositifs d’installation de l’artiste font écho aux strates de mémoire qui se sédimentent — dans le cerveau et dans les sols. Cette démarche lui permet d’explorer la manière dont les symboles se transmettent sans forcément se perpétuer par la parole ou l’écrit. Nos salives, leurs sèves, incarnent l’apparition et l’épuisement des organismes.</div><div style='margin-bottom: 12px;'>Quelles sont les limites de nos règnes ? Sommes-nous immortel·le·s, en perpétuelle réactivation ? Des fluides nous maintiennent en vie – car c’est justement bien de vivant dont il s’agit ici. Des cycles qui nous dépassent entrent en résonance, les jaillissements et les disparitions sont fluctuant·e·s.</div>",
       website: "",
    ...
    "Clémence Mauger": {
      text: "<div style='margin-bottom: 12px;'>L’indétermination plane à tous les niveaux dans le travail pictural de <strong>Clémence Mauger</strong>, et dans le choix des motifs d’abord qui peuvent autant évoquer l’infiniment grand que l’infiniment petit.</div><div style='margin-bottom: 12px;'>Il est notamment nourri d’une imagerie de pointe qui reproduit des éléments imperceptibles à l’oeil nu - comme celles du télescope Hubble ou des microscopes à ondes électriques. Ces images, créées dans le cadre de la recherche scientifique, sont le résultat de la traduction d’informations, souvent non photographiques. En jouant d’ambiguité avec des évocations de cette imagerie scientifique «implacable », le doute plane sur l’origine de ces formes et leur processus de fabrication.</div><div style='margin-bottom: 12px;'>A l’origine, il y a l’intérêt pour les végétaux croisés au quotidien. La contemplation des plantes la nuit, placées sous les lumières artificielles de la ville, a amené Clémence Mauger à photographier et s’inspirer d’une végétation hallucinée, semblant jaillir du béton comme des sortes d’apparitions. La fascination pour la rareté de ces êtres vivants en milieu urbain l’a orientée dans une réflexion à l’opposé d’une nature brute ou sauvage.</div><div style='margin-bottom: 12px;'>Ainsi, elle mixe des motifs de végétaux en plan resserré avec des couleurs acidulées, ou en noir et blanc, et avec un traitement pictural vaporeux. La fine couche de pigments déposée est mise en lumière par le fond du tableau, lisse et lumineux grâce à la préparation à la poudre de marbre. La liquidité et la légèreté de la peinture ainsi que l’absorption minérale du support parlent intrinsèquement de porosité et d’interconnexions environnementales.</div><div style='margin-bottom: 12px;'>Dans les grands écarts d’échelle des références convoquées, la tentation est d’établir des points de comparaison avec des choses connues, mais Clémence Mauger entends pourtant maintenir le doute. Les images fluos des nébuleuses stellaires ou celles acidulées des lames de verre de laboratoire ouvrent un champ de rencontres infinies, aussi mystérieux dans leur confection que dans leur représentation.</div><div style='margin-bottom: 4px; text-decoration: underline; font-weight: bold;'>Biographie :</div><div style='margin-bottom: 12px;'><strong>Clémence Mauger</strong> est née en 1991 à Roubaix. Après un master d’arts plastiques à Paris 1 et un DNSEP à la <strong>Villa Arson</strong> à Nice, elle a été sélectionnée pour le <strong>prix Emerige</strong> en 2020. Elle a présenté deux expositions personnelles au centre d’art <strong>Les églises</strong> à Chelles et à <strong>La Serre</strong> à Saint-Etienne. Trois de ses peintures ont été acquises par le <strong>Frac Auvergne</strong> et deux d’entre elles ont été exposées lors de l’exposition <i>Beautés</i> au FRAC en 2023. Son travail a été aussi présenté au <strong>musée de l’Orangerie</strong> en 2025 lors de l’exposition « Dans le flou, une autre vision de l’art de 1945 à nos jours », qui a ensuite migré au <strong>CaixaForum</strong> à Madrid (« Desen focado, otra visión del arte ») et finalement au <strong>CaixaForum</strong> de Barcelone (printemps 2026).</div><div style='margin-bottom: 12px;'>Clémence Mauger aime adapter sa pratique aux espaces offerts, en créant de grands formats sur mesure ou in situ, comme à Saint-Etienne pour <strong>Le Mur</strong> (2025) et dans le Morbihan pour <strong>L’art dans les chapelles</strong> (été 2026).</div>",
       website: "",
    ...
    "Mikaël Monchicourt": {
        text: "<div style='margin-bottom: 12px;'>Le travail de l'artiste <strong>Mikaël Monchicourt</strong> est fait de détours, de tâtonnements, de questionnements dont l'issue est à rechercher dans un recoin labyrinthique de l'esprit. La pratique ondoie, tout comme les idées chez l'artiste qui procède par assemblage, accumulation, distorsion et effacement combinant des éléments hétérogènes (peinture, encre, impression, colle blanche, aluminium, rhodoïd, tissu, couverture de survie) donnant corps à une image concentrée, où le chaos devient équilibre formel.</div><div style='margin-bottom: 12px;'><strong>Mikaël Monchicourt</strong> décortique, brise, tisse à l'infini des liens entre les images, les mots, leurs sons, leur forme pour les faire basculer d'un état de symbole à celui de matière, physique et palpable, soumise à la loi de la gravité et aux flux.</div><div style='margin-bottom: 12px;'>Les images et les médiums s'entremêlent, se recouvrent pour finalement être piégés dans la résine. L'épaisseur devient plane, compressée, ne laissant que le souvenir de son histoire et de ses aspérités. On voit sans voir, on imagine plutôt, tel un archéologue qui recrée ce qui a pu se jouer sur son lieu de fouille.</div><div style='margin-bottom: 12px;'>Les œuvres de l'artiste sont autant le résultat d'une pratique minutieuse, maîtrisée et consciente que d'une recherche empirique faite de rencontres hasardeuses sur Google Image, de concours de circonstances et d'expérimentations. Il s'interroge sur les circonstances d'existence d'une image, sa mise à distance tout en la précipitant sous une résine qui se voudrait inaltérable.</div><div style='margin-bottom: 12px;'><strong>L'artiste</strong> suit ainsi la route sinueuse de ses obsessions se transformant en collectionneur de statistiques (<i>Le bureau du statisticien</i>, 2014 ; série <i>Stats</i>, 2021) de lettres (<i>Collection de lettres</i>, 2018), de formes, n'hésitant pas à réemployer les images de ses œuvres qu'il dissèque pour leur donner une autonomie et les faire entrer dans un nouvel inventaire (série <i>Sans titre</i>, 2021).</div><div style='margin-top: 12px; font-style: italic;'>— Myriam Boutry, juin 2021</div>",
    ...
    "Eloïse Le Gallo": {
      text: "<div style='margin-bottom: 12px;'>Diplômée des <strong>Beaux-Arts de Paris</strong> en 2013, <strong>Eloïse Le Gallo</strong> travaille en duo avec <strong>Julia Borderie</strong> depuis 2016. Artistes-réalisatrices nées en 1989, elles font de l'expérience de l'altérité une condition de la création artistique. Sur un mode exploratoire, elles s'intéressent à l'interaction profonde que l'eau entretient avec les territoires, de la source à l'océan.</div><div style='margin-bottom: 12px;'>Dans une approche documentaire poétique, l'œil de la caméra opère en catalyseur de rencontre, tout en questionnant les gestes humains qui façonnent matières et territoires. Au cœur d'un maillage de disciplines (artisanat, géologie, chimie, biologie marine), leur travail se développe à la croisée de la sculpture et du cinéma.</div><div style='margin-bottom: 12px;'>Elles sont diplômées du <strong>Fresnoy - Studio national des arts contemporains</strong> en duo en 2023. Récemment, leur recherche porte sur les complémentarités entre forme savante et forme sensible via des collaborations avec des scientifiques.</div><div style='margin-bottom: 4px; text-decoration: underline; font-weight: bold;'>Recherche et publications :</div><div style='margin-bottom: 12px;'>En parallèle, <strong>Eloïse Le Gallo</strong> développe depuis 2012 une recherche sur l'artiste <strong>HC Westermann</strong>. Elle a publié les articles <i>Horace Clifford Westermann, une mécanique de l'idée</i> dans <strong>ArtPress</strong> (février 2019) et <i>Horace Clifford Westermann : si l'homme était une idée !</i> dans les <strong>Cahiers du Musée National d'Art Moderne</strong> (Hiver 2019/2020).</div>",
    ...
    "Lucie Douriaud": {
        text: "<div style='margin-bottom: 12px;'>« Ne rien extraire ni prélever, faire avec l'existant : telle serait la devise de <strong>Lucie Douriaud</strong>, dont l'économie de production observe une éthique de la sobriété reposant sur la récupération des chutes et déchets, leur pulverisation et réemploi. »</div><div style='margin-bottom: 12px;'>« L'extractivisme sans borne qui ravage les écosystèmes, la production accélérée et massive des déchets débordent donc les préoccupations des années 1970. Habituée dès la primaire à faire des nettoyages de printemps en forêt, l'artiste appartient à cette génération saisie par l'éco-anxiété et la solastalgie, ce sentiment d'impuissante tristesse face à la disparition d'un paysage ou d'une saison.</div><div style='margin-bottom: 12px;'>Témoin de la fuite de carburants dans les océans et de plastiques dans les organismes, <strong>Douriaud</strong> pense certaines sculptures comme de véritables pièges, capables d'incorporer des particules de matière dans la course effrénée qui les propulse de la mine à la décharge, de leur site d'extraction à celui de leur enfouissement. »</div><div style='margin-top: 12px; font-style: italic;'>— Hélène Meisel, Collecter, trier, pulveriser, piéger. La méthode Douriaud, bourse Ekphrasis ADAGP, novembre 2024</div>",
    ...
    "Célia Coëtte": {
     text: "<div style='margin-bottom: 12px;'><strong>Célia Coëtte</strong>, née en 1988 en région parisienne, est artiste plasticienne, diplômée des <strong>Beaux-Arts de Paris</strong> en 2016 avec les félicitations du jury. Dans une pratique pluridisciplinaire, tournée principalement vers la sculpture-installation et la performance, son travail évoque des rituels vernaculaires tels que la danse, la fête et le carnaval, tout en abordant en creux la surconsommation et l'épuisement des corps.</div><div style='margin-bottom: 12px;'>Elle a participé au <strong>63ème salon de Montrouge</strong> (2018) et a exposé dans des institutions comme la <strong>Maison des arts de Malakoff</strong> ou le <strong>Parc Saint Léger</strong>, ainsi que dans les galeries <strong>Laure Roynette</strong>, <strong>Isabelle Gounod</strong>, <strong>PCP</strong> ou <strong>Michel Journiac</strong>.</div><div style='margin-bottom: 12px;'>Elle a effectué des résidences à la <strong>Maison Artagon</strong> (2023), à la <strong>Fondation Fiminco</strong> (2025) et au <strong>centre Tignous</strong> (2026). Elle expose également au sein d'artist-run-spaces tels que <strong>DOC!</strong>, <strong>Zone Sensible</strong> ou <strong>le Houloc</strong>, et collabore avec des collectifs comme <strong>Ygrève</strong> ou <strong>Thundercage</strong>.</div><div style='margin-bottom: 12px;'>Depuis 2023, elle écrit et interprète des performances où elle explore les sujets de l'altérité, de l'empathie et du dépassement de soi, enrichies par sa formation en danse contemporaine.</div>",
    ...
    "Raphaël Tiberghien": {
        text: "<div style='margin-bottom: 12px;'>Je m'intéresse aux rapports qu'entretiennent les formes plastiques avec le langage. Au moment où le sens quitte nos représentations mentales pour s'inscrire dans la matière. À celui où un élément de la réalité physique devient significatif à nos yeux. Les mots, comme les objets, sont les supports d'échanges de sens et de valeurs.</div><div style='margin-bottom: 12px;'>Partant d'une pratique de l'écriture, j'utilise l'espace de l'exposition pour déployer cette dernière, la prolonger, l'amplifier, et tenter ainsi de dégager d'autres manières de dire ou de percevoir. À chaque fois, il s'agit de chercher le seuil, le point de bascule entre le fond et la forme. De saisir les dialogues entre le conceptuel et le sensible, la pensée et le corps, l'individuel et le collectif... dans l'atelier, ces notions trouvent leur pendant dans des jeux de transparence et d'opacité, de mollesse, de densité, etc.</div><div style='margin-bottom: 12px;'>J'aime à envisager l'art comme une pratique expérimentale au sein de laquelle des formes hétérogènes participent ensemble de la cohérence d'une recherche. Le son est l'un des éléments du vocabulaire que je développe. Je m'intéresse à sa capacité à occuper un volume, à restituer la temporalité de la parole par l'intermédiaire de la voix. La céramique en est un autre, dont la sensualité peut faire penser à la chair.</div><div style='margin-bottom: 12px;'>J'utilise le métal, le plâtre, le bois, médiums traditionnels de la sculpture, mais aussi des techniques hybrides, mêlant éditions papier ou installations numériques par exemple.</div><div>Ces techniques sont pour moi autant d'outils, avec lesquels je compose comme on assemblerait des signes sur une feuille de papier. L'exploration des porosités entre les catégories de l'expérience artistique vise à faire émerger d'entre les formes et les significations un espace d'observation ouvert sur des réalités humaines ; j'ai le sentiment d'avoir atteint mon objectif quand une pièce fonctionne comme un révélateur.</div>",
    ...
    "Mercedes Semino": {
        text: "<div style='margin-bottom: 12px;'>Architecte de l'illusion, <strong>Mercedes Semino</strong> troque les motifs naturels pour des ruines contemporaines aux couleurs prémodernes. Dans ce décor surréaliste, inutile de chercher une perspective logique. L'artiste s'amuse à nous perdre dans un labyrinthe d'escaliers sans arrivée pour mieux nous interroger sur l'appropriation humaine de l'espace, à l'épreuve du temps.</div><div style='margin-bottom: 12px;'>La texture granuleuse de ses toiles architecturales convoquerait une ancienne fresque de <strong>Giotto</strong> sortie de l'oubli.</div><div style='margin-bottom: 12px;'>Diplômée des <strong>Beaux-Arts de Paris</strong> en 2018, <strong>Mercedes</strong> prolonge l'aspect granuleux dans ses céramiques design, contrastant avec la rigidité des lignes qui les ornent.<br><br>Voilà de quoi contrarier les angles droits qui n'existent aussi parfaitement que dans les sociétés industrialisées.</div>",
        website: "",
    ...
    "Vanina Langer": {
        text: "<div style='margin-bottom: 12px;'>Mon travail questionne notre relation à l'infini, du vivant et de l'espace. Son inconcevabilité pour notre esprit qui pense en termes de contenu/contenant, me fascine. Dans l'histoire de l'art, j'ai toujours été interpellée par la relation des figures au fond, arrière-plan mais aussi sens de l'œuvre, qui lorsqu'il s'agit d'un chef d'œuvre, fuit toujours ailleurs, laissant le spectateur dans un cheminement éternel.</div><div style='margin-bottom: 12px;'>Les sujets qui travaillent mes œuvres sont la femme, la nature et la culture du sens et d'une spiritualité dans la création d'images et de mythologies. Le motif du lien – ligne de fuite tout comme liane lancée dans sa course à la lumière, est un fil conducteur plastique et théorique.</div><div style='margin-bottom: 12px;'>Qu'il s'agisse de dessins ou d'installations, d'œuvres monumentales ou de microcosmes miniatures, je pars toujours d'une chute, d'un fragment ; tout se meut ensuite comme une plante. Je dessine, recouvre, coupe et pare jusqu'à une forme de cuisson. Les motifs se reproduisent pour être recouverts, retaillés, recousus, ré-parés… jusqu'à ce que le fond et la forme semblent rester en suspens.</div><div>J'accumule références et motifs par analogies jusqu'à une forme d'éclatement polysémique. Son mystère s'exprime souvent dans des œuvres totales proposant au spectateur une expérience polysensorielle. Les mythologies que je compose sur quelques années tendent de plus en plus vers une forme de fête.</div>",
    ...
    "Elisa Chaveneau": {
       text: "<div style='margin-bottom: 12px;'><strong>Elisa Chaveneau</strong> est née en 2000 à Châtellerault. Elle vit et travaille à Paris. Artiste plasticienne, elle est diplômée du DNSEP MAGMA (Art & Géomatériaux) aux <strong>Beaux-Arts du Mans</strong> et d'un master en Recherche et Création - Écologie des arts et des médias à l'<strong>Université Paris-Vincennes</strong>.</div><div style='margin-bottom: 12px;'>Elle développe dans sa pratique artistique une cohabitation sensible autour des relations inter-espèces, entre les humains et les non-humains. Elle interroge nos relations et notre capacité à coexister avec les vivants autres qu'humains à travers des sculptures et des installations, mais aussi par le dessin ou le son.</div><div style='margin-bottom: 12px;'>Ses recherches se fondent sur l'idée d'une crise de la sensibilité, c'est-à-dire une perte de lien avec les formes de vies autres qu'humaines, invisibles, rendues muettes par nos systèmes productivistes.</div><div style='margin-bottom: 12px;'>Elle a exposé au <strong>Musée d'Art Moderne de Paris</strong> (<i>Les Flammes</i>, 2021), au <strong>Centre Céramique Contemporaine de La Borne</strong> (<i>Digital Soba</i>), à la <strong>Biennale Internationale Design de Saint-Étienne</strong> (<i>Le monde Sinon rien</i>, 2022) et au <strong>Jardinier de Montrouge</strong> en 2025.</div><div style='margin-bottom: 12px;'>Récemment, elle a exposé à Paris au <strong>Wonder</strong> (<i>Summer Body</i>) et au <strong>Micro Centre d'Art de L'éprouvette</strong> (<i>Terra Strata</i>), aux côtés de <strong>Noémie Vincent-Maudry</strong> avec qui elle a co-fondé le studio <strong>Nom'É</strong> en 2025.</div>",
    ...
    "Kevin Rouillard": {
        text: "<div style='margin-bottom: 12px;'><strong>Kevin Rouillard</strong> crée des installations et des sculptures murales à partir de bidons qu'il aplatit en les martelant, ou de plaques en métal soudées ensemble. Imposantes et austères, ses pièces s'appuient sur la logique du recyclage : il récupère des matériaux destinés à être transformés – bidons, plaques métalliques – pour les classer, les organiser, les soumettre à un procédé qui les amenuise et les soustrait à la circulation des biens.</div><div style='margin-bottom: 12px;'>Ce geste de soustraction nous invite à une pause dans la logique de consommation.</div><div style='margin-bottom: 12px;'>Son choix de matériaux se fait sans hiérarchie : aucune pièce n'est privilégiée par rapport à une autre, toutes deviennent égales et neutres, purifiées de leur contexte. Même les traces accidentelles – fragments de logo ou bouts d'étiquette – perdent leur signification. En dehors de toute narrativité, ses pièces créent une zone de contemplation pure.</div><div style='margin-bottom: 12px;'>Cette vision résulte d'une indifférence pour l'objet en tant qu'objet. L'œuvre de <strong>Kevin</strong> résiste à toute catégorisation : ready-made, sculpture, peinture minimaliste ou Color Field ? Elle entre dans un interstice terminologique pour inventer une nouvelle identité : « tôle, choc ».</div><div>Les traces de geste – enfoncements, blessures, cicatrices de soudure – communiquent à ses œuvres un aspect humain, une fragilité qui atténue leur aspect guerrier. L'œuvre devient un xylophone silencieux, une symphonie qui s'écoule dans l'espace.</div>",
...
window.addEventListener("scroll", () => {
 ...
 Object.keys(elements).forEach((id) => {
    ...
    if (el) {
        ...
        if (isMobile) {
            // --- MOBILE LOGIK: Keine Animation auf Mobile ---
    ...
    if (boxTopArt) {
        boxTopArt.style.transform = isMobile ? "none" : `translate(${scroll * -0.07}px, ${scroll * -0.04}px) rotate(-1deg)`;
    }
    if (boxMidArt) {
        boxMidArt.style.transform = isMobile ? "none" : `translate(${scroll * 0.1}px, ${scroll * 0.02}px) rotate(0deg)`;
    }
    if (boxBottomArt) {
        boxBottomArt.style.transform = isMobile ? "none" : `translate(${scroll * -0.03}px, ${scroll * 0.08}px) rotate(-1.5deg)`;
    }
    if (greenDotsArt) {
        greenDotsArt.style.transform = isMobile ? "none" : `translateX(${scroll * -0.12}px) rotate(2.2deg)`;
    }
...
const archiveData = {
    nymphs: {
     ...
     description: "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>César Bardoux, Ulysse Bordarias, Mélissa Boucher Morales, Marta Budkiewicz, Léa de Cacqueray, Célia Coëtte, Agathe Dos Santos, Lucie Douriaud, Valentine Esteve, Hugo Ferretto, Charlotte Heninger, Amalia Jaulin, Joerg Hurschler, Adalbert Khan, Éloise Le Gallo & Julia Borderie, Rodolphe Macabéo, Audrey Matt Aubert, Mikaël Monchicourt, Lenny Rébéré, Sidonie Ronfard, Mathieu Roquigny, Laura Rouzet, Chloé Sassi, Lise Stoufflet, Laure Tiberghien, Lucas Tortolano, Romain Vicari</span></div><div><b>COMMISSAIRE :</b> <span class='archive-artist-name'>Salomé Fau</span></div>",
...
fortdaubervilliers: {
      ...
      description: "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Melissa Boucher Morales, Laura Rouzet, Marta Budkiewicz, Lise Stoufflet, Lucie Douriaud, Valentine Esteve, Daniela Stubbs-Levi, Adalbert Khan, Joerg Hurschler, Lenny Rebere, Mathieu Roquigny</span></div>",
...
description: "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Simon Bérard, Pauline Brun, Tom Giampieri, Justin Sanchez</span></div><div style='margin-bottom: 12px;'><b>TEXTE :</b> <span class='archive-artist-name'>Charlotte Imbault</span></div>",
     ...
     description: "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Marta Budkiewicz, Célia Coëtte, Joerg Hurschler, Adalbert Khan, Eloise Le Gallo et Julia Borderie, Camille Pogu, Mathieu Roquigny, Laura Rouzet, Mercedes Semino</span></div>",
      flyer: "img/Equinox-sunrise_h_2.jpg",
       ...
       humannature: {
      title: "HUMAN NATURE",
description: "<div style='margin-bottom: 12px;'><b>COMMISSAIRE :</b> <span class='archive-artist-name'>Cédric Esturillo Cacciarella</span></div><div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Romain Coppin, Cédric Esturillo Cacciarella, Frédéric Houvert, Raphaëlle Sabattié, Marijke Vasey</span></div><div><b>SCÉNOGRAPHIE :</b> <span class='archive-artist-name'>Léa Michel</span></div>",
 flyer: "img/Human-nature_1.jpg",
    ...
    jaimeraisemporterlefeu: {
        ...
        description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Debby Barthoux, Kristofer Hart et Guilhem Roubichou</span></div><div><b>COMMISSARIAT :</b> <span class='archive-artist-name'>Debby Barthoux et Guilhem Roubichou</span></div>",
    ...
    shabiter: {
        title: "S'HABITER",
description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Sirine Ammar, Guillaume Constantin, Fanny Didelon, Mathilde Geldhof, Agnès Geoffray, Lise Stoufflet, Raphaël Tiberghien, Pauline Toyer & Adalbertkhan Vojta</span></div><div><b>COMMISSARIAT :</b> <span class='archive-artist-name'>Mathilde Geldhof</span></div>",
    ...
    flatorama: {
        title: "FLAT-O-RAMA",
description:
            "<div style='margin-bottom: 12px;'><b>COMMISSARIAT :</b> <span class='archive-artist-name'>Sirine Ammar et Eléonore Geissler</span></div><div><b>ARTISTES :</b> <span class='archive-artist-name'>Sarah Anaïs Desbenoit, Jot Fau, Ismail Alaoui Fdili, Albin Poupart, Zoé Thonet</span></div>",
...
description:
            "<div style='margin-bottom: 12px;'><b>COMMISSARIAT :</b> <span class='archive-artist-name'>Mathieu Buard et Tom Chatenet</span></div><div><b>ARTISTES :</b> <span class='archive-artist-name'>Jeanne Briand, Tom Chatenet, Carina Emery, Jacent, Agathe Jourdan, Marlon Kroll, Mathis Pettenati, Arto Van Hasselt, Xolo Cuintle</span></div>",
    ...
    eteculturel2023: {
        ...
        description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Les Froufrous de Lilith (Camille Zéhenne & Bulle Meignan)</span></div><div><b>COMMISSARIAT :</b> <span class='archive-artist-name'>Mathilda Portoghese</span></div>",
    ...
    poursuitofpleasure: {
        ...
        description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Anna Àdam, Àgoston Bényi, Mélissa Boucher, Quentin Fromont, Valentine Gentilleau, Andrea Éva Györi, Marilou Poncin, Peter Puklus</span></div><div><b>COMMISSAIRE :</b> <span class='archive-artist-name'>Timea Urbantsok</span></div>",
    ...
    cloud: {
        title: "CLOUD",
        description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Capsule collectif</span></div>",
    ...
    mues: {
        title: "MUES",
        description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Mélissa Boucher, Marta Budkiewicz, Célia Coëtte, Valentine Esteve, Hugo Ferretto, Mathilde Geldhof, Joerg Hurschler, Adalbert Khan, Lenny Rébéré, Mathieu Roquigny, Lise Stoufflet, Raphaël Tiberghien</span></div>",
...
description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Melt (Pali Meursault & Thomas Tilly), Sébastien Roux, Matthieu Saladin, Tachycardie, Lauren Tortil, Clara De Asis, Batmoon, Arnaud Dezoteux, Celsian Langlois</span></div><div><b>GRAPHISME :</b> <span class='archive-artist-name'>Guillaume Ettlinger</span></div>",
    ...
    unelunedecarbone: {
        ...
        description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Pamela Artist-Run Space (Juliette Bentahar, Marine Chrétien, Margaux Fontaine, Colin G., Won Jy, Steven Le Priol, Audrey Martin, Lydia Rump, Margaux Szymkowicz)</span></div>",
...
description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>César Bardoux, Ulysse Bordarias, Mélissa Boucher, Marta Budkiewicz, Camille Le Chatelier, Hugo Ferretto, Flavie L.T, Jean Claracq, Célia Coëtte, Mathilde Geldhof, Audrey Matt Aubert, Mikaël Monchicourt, Lenny Rébéré, Mathieu Roquigny, Lise Stoufflet, Raphaël Tiberghien et Romain Vicari</span></div><div><b>PHOTOGRAPHIES :</b> <span class='archive-artist-name'>Séverine Fernandes - Ville de Malakoff</span></div>",
...
description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Collectif Diamètre</span></div><div><b>DESIGN GRAPHIQUE :</b> <span class='archive-artist-name'>Mahaut Rey</span></div>",
    ...
    ohnetitel: {
        title: "OHNE TITEL",
        description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Steeve Bauras</span></div><div><b>FREE FRAGS :</b> <span class='archive-artist-name'>François Bianco</span></div>",
    ...
    festivalvhs: {
        title: "FESTIVAL VHS",
        description:
            "<div style='margin-bottom: 12px;'><b>ARTISTES :</b> <span class='archive-artist-name'>Elsa Brès, Tohé Commaret, Sarah-Anaïs Desbenoit, Cédric Dupire, Laura Huertas Millán, Jorge Jacome, Quentin L'Helgoualc'h, Valentin Noujaïm</span></div>",
        info: "30+31 Mai 2025",
    ...
    carteblanaceyasminebenabderrahmane: {
        ...
        description:
            "<div style='margin-bottom: 12px;'>Elsa Brès, Kate Krolle, Thibaud Le Maguer et Faye Mullen ainsi qu'Ana Bordenave, chercheuse spécialisée en art contemporain, qui animera cette soirée.</div>",
        info: "9 octobre 2020",
...
const performanceData = {
    "diner-noel-2024": {
        ...
        description: "<div style='margin-bottom: 12px;'>PENSÉ PAR L'ARTISTE ARIA SENE (DOUCE STUDIO)</div>",
        info: "",
    ...
    "tout-commencera-par-un-verre": {
        ...
        description: "<div style='margin-bottom: 12px;'>ÉVÈNEMENT CULINAIRE PENSÉ ET RÉALISÉ PAR LUC AVARGUES</div>",
        info: "4 mai 2023",
    ...
    "diner-noel-culinaire-2021": {
        ...
        description: "<div style='margin-bottom: 12px;'>CARTE BLANCHE à LUZ MORENO PINART</div>",
    ...
    "premiere-fete-soleil-nord-est": {
        ...
        description: "<div style='margin-bottom: 12px;'>CARTE BLANCHE à COLLECTIF 16AM</div>",
    ...
    "dune-rive-a-lautre": {
        ...
        description: "<div style='margin-bottom: 12px;'>TABLE RONDE</div>",
        info: "23 septembre 2021",
        flyer: "img/perf-dune-rive-a-lautre-01.avif",
    ...
    "raccords-soleil-nord-est": {
        ...
        description: "<div style='margin-bottom: 12px;'>CARTE BLANCHE à HBT</div>",
        info: "novembre 2020",
    ...
    "diner-noel-2019": {
        ...
        description: "<div style='margin-bottom: 12px;'>INTERVENTION CULINAIRE DE BYE BYE PEANUTS</div>",
    ...
    "lectures-et-accrochage": {
        ...
        description: "<div style='margin-bottom: 12px;'>AVEC ET AUTOUR DE STÉPHANE CRÉMER</div>",
    ...
    "capharnaum": {
        title: "CAPHARNAÜM",
        description: "<div style='margin-bottom: 12px;'>Sur une proposition du Cercle Chromatique, dans le cadre de \"Le Cercle s'ouvre\"</div>",
    ...
    "soleil-nord-est-performances-sonores": {
        ...
        description: "<div style='margin-bottom: 12px;'>MÉRYLL AMPE - RIOUX/ROUSSEL</div>",
    ...
    "diner-noel-culinaire-sonore": {
        ...
        description: "<div style='margin-bottom: 12px;'>CARTE BLANCHE À CELSIAN LANGLOIS</div>",
        info: "2017",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (closeBtn && archiveOverlay) {
        ...
        archiveOverlay.addEventListener("click", (e) => {
            if (!archiveOverlay.contains(e.target) || e.target === archiveOverlay) {
                archiveOverlay.classList.remove("active");
                document.body.style.overflow = "auto";
            }
        });
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    infoOverlay.addEventListener('click', (e) => {
        if (!infoOverlay.contains(e.target) || e.target === infoOverlay) {
            closeInfoOverlay();
        }
    });
});

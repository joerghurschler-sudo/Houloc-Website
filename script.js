...
const artistData = {
    ...
    "Laure Tiberghien": {
        text: "Il n'est pas rare, à propos des photographies sans appareil de Laure Tiberghien, de faire référence aux peintures de Mark Rothko ou de Barnett Newman. Les œuvres de l'artiste, le plus souvent composées d'aplats colorés et de bandes ou lignes vibratoires, trouvent de fait des échos formels convaincants auprès de ces deux figures majeures de l'histoire de l'art américain. Pour autant, il semble que son œuvre aurait à gagner à se défaire au moins temporairement de cette possible généalogie. D'abord parce que la question de l'abstraction n'est sans doute pas de celles qui comptent vraiment pour Laure Tiberghien. Sans pour autant vouloir renouer avec un quelconque désir de représentation, elle signale que les enjeux sont ailleurs.<br><br>L'artiste insiste sur les gestes qui président à ses images. Si elle évoque volontiers la dimension physique, voire chorégraphique du travail en laboratoire – « ce qui donne cet aspect vaporeux à l'image », explique-t-elle, « c'est le fait que je sois toujours en train de bouger » – elle souligne aussi l'incidence forte du type de support sur le rendu (sa brillance ou sa matité, son chatoiement), et la part de hasard inhérente au processus qu'elle aime guetter et amplifier. Le papier photographique n'est pas seulement pour Laure Tiberghien le lieu où la lumière agit, mais aussi celui où se matérialise le contact de l'image avec le monde : l'air qui l'oxyde est aussi celui que nous respirons, et nous partageons cet invisible commun.<br><br>C'est aussi une logique ready-made qui guide Laure Tiberghien lorsqu'elle récupère d'anciens papiers citrates qu'elle laisse progressivement brunir à la lumière. Ces petits rectangles de feuille sensible, en apparence modestes, sont parmi ses pièces les plus directes et les plus explicites. Ils tracent une autre voie que celle des références d'artistes peintres ou photographes, qui est celle du travail de la lumière, de sa traduction dans la matière photochimique soumise à l'écoulement du temps – notion considérée comme décisive par l'artiste. Les images de Laure Tiberghien, de ce point de vue, sont des matrices temporelles. Elles génèrent des zones colorées plus ou moins intenses résultant d'une certaine durée, des sortes de « couleurs-temps ».<br><br>Fruit du hasard mais aussi des collectes de l'artiste, matière changeante soumise à variations, résultat conjoint d'un support, d'un geste et d'une action lumineuse, ce que donne à voir l'œuvre n'est autre que la consistance même du temps.<br><br>Nathalie Delbard",
